...
class Day16Test {
    ...
    fun partOneRealInput() {
        Assert.assertEquals("10100101010101101", Day16(272, "11101000110010100").solvePart1())
    }

    @Test
    fun partTwoRealInput() {
        Assert.assertEquals("01100001101101001", Day16(35651584, "11101000110010100").solvePart2())
    }
}